        ...
        <div className="row justify-content-center">
          <div className="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                ...
                <form className="row g-2 needs-validation" noValidate>
                  ...
                  <div className="col-12 pb-1 pt-1">
                    <div className="form-check">
                      <input className="form-check-input" type="checkbox" name="loginRemember" value="true" id="loginRememberMe"/>
            ...
            <div className="credits" align="center">
              ...
              <br/><a href={ksuLink}>Kahramanmaraş Sütçü İmam Üniversitesi</a>
            </div>
