...
const Documents = () => {
  ...
  const softwareInternshipCheck = () => {
    const softwareInternship = currentUserInternships.find((item) => item.internship === 'software')

    if (softwareInternship.companyApproval && softwareInternship.consultantApproval) {
      return (
        {
          label: 'Yazılım Stajı',
          key: '1',
      ...
      return (
        {
          ...
          children: ( 
            ...
            >
                <Alert 
                    message="Yazılım Staj Başvurusunun Onaylanması Bekleniyor" 
                    type="info"     
                    showIcon
                    style={{
                        fontFamily: 'open sans'
  ...
  const hardwareInternshipCheck = () => {
    const hardwareInternship = currentUserInternships.find((item) => item.internship === 'hardware')

    if (hardwareInternship.companyApproval && hardwareInternship.consultantApproval) {
      return (
        {
          label: 'Donanım Stajı',
          key: '2',
      ...
      return (
        {
          ...
          children: ( 
            ...
            >
                <Alert 
                    message="Donanım Staj Başvurusunun Onaylanması Bekleniyor" 
                    type="info"     
                    showIcon
                    style={{
                        fontFamily: 'open sans'
  ...
  const umeInternshipCheck = () => {
    const umeInternship = currentUserInternships.find((item) => item.internship === 'ume')

    if (umeInternship.companyApproval && umeInternship.consultantApproval) {
      return (
        {
          label: 'UME Stajı',
          key: '3',
      ...
      return (
        {
          ...
          children: ( 
            ...
            >
                <Alert 
                    message="UME Staj Başvurusunun Onaylanması Bekleniyor" 
                    type="info"     
                    showIcon
                    style={{
                        fontFamily: 'open sans'
        ...
        </Title>
          {
            currentUserInternships.length !== 0 ?
              (
                <Tabs
                  items={[
                    currentUserInternships
                      .find((item) => item.internship === 'software') && softwareInternshipCheck(),
                    currentUserInternships
                      .find((item) => item.internship === 'hardware') && hardwareInternshipCheck(),
                    currentUserInternships
                      .find((item) => item.internship === 'ume') && umeInternshipCheck()
                  ]}
                  centered
                  style={{
                    fontFamily: 'open sans'
